...
<div style="position: relative; margin:20px 9% 0 9% ">
  ...
  <div style="font-weight: 550; opacity: 0.9; margin-top: 20px">
    ...
    <el-col :span="8" style="width: 220px;margin: 0 20px 20px 0; position: relative">
      <el-card :body-style="{padding:'28px'}" style="color: dimgray; cursor: default" @click="downloadHuXiInfo">
        <div class="ecard">
          ...
          <span style="position: absolute; top: 35%">虎溪校区住宿上报信息</span>
        </div>
      </el-card>
    </el-col>
    ...
    <el-col :span="8" style="width: 220px;margin: 0 20px 20px 0; position: relative">
      <el-card :body-style="{padding:'28px'}" style="color: dimgray; cursor: default" @click="downloadAward">
        <div class="ecard">
          <svg t="1649560339161" class="icon" viewBox="0 0 1109 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1649" width="30" height="30"><path d="M834.653612 0c59.178346 0 124.713991 41.386442 151.252514 95.40215l108.372747 220.96947c27.093187 55.2957 16.767909 132.99128-23.765205 178.900364L637.876012 985.423996c-45.48242 51.455721-120.959345 51.413055-166.399099 0L38.839256 495.271984C-1.693857 449.362899-12.019135 371.624654 15.074052 316.37162l108.33008-220.926804C149.899988 41.258443 215.392967 0 274.613979 0z m-257.491938 179.753693a42.666436 42.666436 0 0 0-58.069019 16.341245L459.103647 303.102358a42.666436 42.666436 0 0 1-31.743828 21.418551l-123.391332 15.957247a42.666436 42.666436 0 0 0-23.46654 73.642268L363.445498 490.664009a42.666436 42.666436 0 0 1 12.970596 39.38112l-21.034552 109.652739a42.666436 42.666436 0 0 0 59.861009 46.719747l118.186026-54.741037a42.666436 42.666436 0 0 1 36.650468 0.341332l116.9487 56.959691a42.666436 42.666436 0 0 0 60.757005-45.525086l-18.773232-109.994071a42.666436 42.666436 0 0 1 13.781259-39.125122l84.692874-75.007593a42.666436 42.666436 0 0 0-22.015881-74.111599l-122.708668-18.218568a42.666436 42.666436 0 0 1-31.402497-22.186546l-57.386356-107.818083a42.666436 42.666436 0 0 0-16.810575-17.194574z" fill="#F5906C" p-id="1650">

          </path></svg>
          <span style="position: absolute; top: 35%">获奖/荣誉称号统计</span>
        </div>
      </el-card>
    </el-col>

    <el-col :span="8" style="width: 220px;margin: 0 20px 20px 0; position: relative">
      <el-card :body-style="{padding:'28px'}" style="color: dimgray; cursor: default" @click="downloadScholarship">
        <div class="ecard">
          <svg t="1647956009214" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4980" width="30" height="30"><path d="M520.8 149c-4.9-2.4-13-2.4-17.9 0L105.3 345.4c-4.9 2.4-9 8.9-9 14.4v267c0 5.5 4.5 10 10 10l811.3 2.5c5.5 0 10-4.5 10-10l-0.3-269.6c0-5.5-4-12-9-14.4L520.8 149z" fill="#78909C" p-id="4981"></path><path d="M789 518.6H360.9c-5.5 0-10-4.5-10-10V146.4c0-5.5 4.5-10 10-10H789c5.5 0 10 4.5 10 10v362.2c0 5.5-4.5 10-10 10z" fill="#FF5722" p-id="4982"></path><path d="M693 582.3H264.9c-5.5 0-10-4.5-10-10V210.2c0-5.5 4.5-10 10-10H693c5.5 0 10 4.5 10 10v362.2c0 5.4-4.5 9.9-10 9.9z" fill="#FFCCBC" p-id="4983"></path><path d="M106.4 887.6c-5.5 0-10-4.5-10-10v-519c0-5.5 4.1-8.1 9.1-5.8l396.8 182c5 2.3 13.2 2.3 18.2 0l397.9-182c5-2.3 9.1 0.3 9.1 5.8l0.3 519.1c0 5.5-4.5 10-10 10l-811.4-0.1z" fill="#CFD8DC" p-id="4984"></path><path d="M575.3 720.1h-48.5v-32.3h48.5c8.9 0 16.1-7.2 16.1-16.1s-7.2-16.1-16.1-16.1h-33.1l31.4-57.9c4.1-7.3 1.6-16.7-5.3-21-6.9-4.2-15.7-1.7-19.7 5.6l-36 66.6c-1.1 2.2-1.7 4.5-1.9 6.8h-0.2c-0.2-2.3-0.7-4.6-1.9-6.8L473 582.3c-4-7.3-12.7-9.8-19.5-5.6s-9.2 13.7-5.2 21l31 57.9h-33.1c-8.9 0-16.1 7.2-16.1 16.1 0 8.9 7.2 16.1 16.1 16.1h48.5v32.3h-48.5c-8.9 0-16.1 7.2-16.1 16.1 0 8.9 7.2 16.1 16.1 16.1h48.5v33.9c0 8.1 7.2 14.6 16.1 14.6s16.1-6.5 16.1-14.6v-33.9h48.5c8.9 0 16.1-7.2 16.1-16.1 0.1-8.9-7.3-16.1-16.2-16.1zM318.2 285.9H639v64.5H318.2z" fill="#FF5722" p-id="4985">

          </path></svg>
          <span style="position: absolute; top: 35%">奖学金统计</span>
        </div>
      </el-card>
    </el-col>
...
export default {
  ...
  methods:{
    ...
    downloadScholarship(){
      request.post('/downLoadScholarship',this.user).then(res=>{
        this.downloadFile(res.data)
      }).catch(err=>{
        this.$message.error("下载失败")
      })
    ...
    downloadAward(){
      request.post('/downLoadAwardInfo',this.user).then(res=>{
        this.downloadFile(res.data)
      }).catch(err=>{
        this.$message.error("下载失败")
      })

        ...
        <el-scrollbar max-height="300px">
          <el-card>
            <el-descriptions style="padding: 10px 5px 0 5px">
              ...
              <el-descriptions-item label="认定时间:">{{otherList3.data.other_time.substring(0,4)}}</el-descriptions-item>
        ...
        <el-dialog
          ...
          <el-form ref="form" :model="otherThing" style="margin:30px 0 0 60px; font-weight: bold">
            ...
            <el-form-item label="加分项目" style="margin-bottom: 40px; margin-right: 2%; width: 46%">
              <el-input v-model="otherThing.other_name" placeholder="课外体育锻炼加分项" clearable></el-input>
            </el-form-item>
